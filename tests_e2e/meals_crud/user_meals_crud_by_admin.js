...
describe('Other user meals CRUD by admin', function () {

    it('should access the page of editing user meals correctly', function () {
        // logout
        ...
        element(by.model('email')).sendKeys('admin@test.com');
        element(by.model('password')).sendKeys('qwerty123');
        ...
        element(by.repeater('user in userlist').row(1))
            .all(by.css('.fa-bars')).first().click();
